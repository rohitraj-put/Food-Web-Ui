    ...
    <div className="flex flex-row  max-md:flex-col-reverse  justify-center py-10 gap-2 mt-12 max-md:mt-4 px-10 max-md:px-2">
      ...
      <div className="w-1/2 max-md:w-full p-7 max-md:px-2">
        ...
        <div className="flex justify-center flex-row gap-2 py-2.5">
          <div
            className="w-48 max-md:w-full max-md:min-h-52 min-h-44 shadow-sm  rounded-md bg-white py-2.5"
            data-aos="flip-down"
          >
          ...
          <div
            className="w-48 max-md:w-full max-md:min-h-52 min-h-44 shadow-sm  py-2.5 rounded-md bg-white"
            data-aos="flip-down"
          >
